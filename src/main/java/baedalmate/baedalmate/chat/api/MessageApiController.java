...
//        }
        ...
        // 채팅방 조회
        ChatRoom chatRoom = chatRoomService.findOne(messageDto.getChatRoomId());

        // 메세지 db 저장
        messageService.createMessage(messageDto.getChatRoomId(), messageDto.getSenderId(), MessageType.TALK, messageDto.getMessage());
