...
import baedalmate.baedalmate.recruit.dto.TagDto;
...
@NoArgsConstructor
@Schema
public class MainPageRecruitWithTagListResponseDto {
    private List<MainPageRecruitWithTagResponseDto> recruitList;
    @Getter
    @Setter
    @ToString
    @NoArgsConstructor
    @Schema
    static class MainPageRecruitWithTagResponseDto {
